...
<script>
    function loadTable() {
        $('#load-table').load('page/return-penjualan/tabel-return-penjualan.php')
    }
    $(document).ready(function () {
        ...
        $('#tambah').on('click', function () {
            ...
            // load form
            $('.modal-body').load('page/return-penjualan/tambah-return-penjualan.php');
        });
    });
</script>