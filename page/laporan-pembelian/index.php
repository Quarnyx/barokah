...
<?php if (isset($_GET['dari_tanggal']) && isset($_GET['sampai_tanggal'])) { ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h4 class="text-center mt-3 mb-3"><b>TOKO BAROKAH</b><br><b>LAPORAN PEMBELIAN</b><br>Periode <?php
                ...
                <div class="card-body">
                    ...
                    <table id="tabel-data" class="table table-bordered table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            $harga_beli = 0;
                            $harga_jual = 0;
                            $query = mysqli_query($conn, "SELECT * FROM v_pembelian WHERE tanggal_pembelian BETWEEN '$_GET[dari_tanggal]' AND '$_GET[sampai_tanggal]'");
