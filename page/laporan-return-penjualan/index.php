<?php
$sub_title = "Laporan Laporan Return Penjualan";
...
<?php if (isset($_GET['dari_tanggal']) && isset($_GET['sampai_tanggal'])) { ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h4 class="text-center mt-3 mb-3"><b>TOKO BAROKAH</b><br><b>LAPORAN RETURN PENJUALAN</b><br>Periode <?php
                ...
                <div class="card-body">
                    ...
                    <table id="tabel-data" class="table table-bordered table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                            <?php
                            include "config.php";
                            $query = mysqli_query($conn, "SELECT * FROM v_returnpenjualan WHERE tanggal_return_penjualan BETWEEN '" . $_GET['dari_tanggal'] . "' AND '" . $_GET['sampai_tanggal'] . "' ORDER BY id_return_penjualan DESC");
                            while ($data = mysqli_fetch_array($query)) {
                                ?>
                                <tr>
                                    <td><?= $data['kode_return_penjualan'] ?></td>
                                    <td><?= $data['tanggal_return_penjualan'] ?></td>
